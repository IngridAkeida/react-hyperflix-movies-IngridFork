...
const SearchField = () => {
  ...
  return(
    ...
    <div className="relative">
        ...
        <input type="search" id="default-search" className="block w-full p-4 ps-8 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-m_gold focus:border-m_gold dark:bg-gray-700 dark:border-gray-600 placeholder-m_gold dark:text-white dark:focus:ring-m_gold dark:focus:border-m_gold" gughogplaceholder="Search for Movies..." value={query}
